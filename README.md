...
1. **HTML rapor** · SEO + GEO + rakip + talep havuzu + sosyal duygu + CRO/CX bulguları. Inbound
   raporuyla aynı tarz; renkler hedef markaya uyarlanır.
2. **HTML tasarım örneği** · hedef domainin header/nav/footer'ı korunur, sayfa içi gövde CRO/CX/UI-UX'e
   göre **4 varyant** + sağda yüzen varyant seçici ile geliştirilir.
3. **Sunum (opsiyonel)** · Inbound Design System ile, raporun tüm bölümlerini yansıtan deck.
...
## Nasıl çalışır
1. **Intake** · hedef URL + hedef kelime zorunlu; ekran görüntüsü/marka rengi/rakip/doküman/sunum
   tercihi netleştirilir. Eksikse önce sorulur.
2. **Araştırma** · kelime/SERP/AI Overview/Trends/rakip/sosyal veri (varsa DataForSEO + Ahrefs).
...
- DataForSEO ve/veya Ahrefs MCP (kelime/SERP/AI Overview verisi) · yoksa graceful düşer, kullanıcıdan
  veri ister.
